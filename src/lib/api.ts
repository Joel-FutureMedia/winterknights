...
import type { ApiResponse, City, Corner, Company, Invoice, Payment, BookingRequest, LoginResponse, PaymentStatusResponse, TotalSpentResponse, CompanyPaidSummary, User, PublicRegisteredCompany } from '@/types';
...
export const publicApi = {
  getRegisteredCompanies: () => api.get<ApiResponse<PublicRegisteredCompany[]>>('/public/companies'),
};
