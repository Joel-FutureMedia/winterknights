...
import secondSectionImage from '@/assets/secondsection.jpg';
...
const Index: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="gradient-navy relative overflow-hidden min-h-[78vh] flex items-start">
        ...
        <div className="container mx-auto px-4 pt-8 pb-14 md:pt-10 md:pb-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 items-start lg:items-stretch">
            <motion.div
            ...
            >
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 gradient-gold px-8 py-3 rounded-md font-display uppercase text-sm tracking-wider text-white transition hover:opacity-90"
                >
            ...
            <motion.div
              ...
              className="flex w-full min-h-[280px] h-[clamp(300px,52vh,min(72vh,680px))] lg:h-full lg:min-h-[22rem] items-center justify-center"
            >
              <img
                src={landingPageImage}
                alt="Winter Knights landing"
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center lg:items-stretch">
            <motion.div
              ...
              className="rounded-2xl border-2 border-gold/45 bg-white p-4 shadow-[0_18px_45px_rgba(19,175,238,0.28)]"
            >
              <NamibiaMap />
            </motion.div>
            <motion.div
              ...
              className="flex w-full min-h-[280px] h-[clamp(300px,48vh,min(68vh,640px))] lg:h-full lg:min-h-[20rem] items-center justify-center"
            >
              <img
                src={secondSectionImage}
                alt="Winter Knights second section"
                className="h-auto w-full max-h-full object-contain"
              />
            </motion.div>
          </div>
      ...
      <section className="gradient-navy py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            to="/companies/register"
            className="mt-8 inline-flex items-center gap-2 gradient-gold px-10 py-4 rounded-md font-display uppercase tracking-wider text-white transition hover:opacity-90"
          >
