        ...
        {status === 'success' && (
          <div className="space-y-4">
            ...
            <div className="pt-2 space-y-2">
              <Link
                to="/companies/login"
                className="inline-flex items-center justify-center w-full gradient-gold text-primary font-display uppercase tracking-wider py-3 rounded-md hover:opacity-95 transition"
              >
                Login to dashboard
              </Link>
