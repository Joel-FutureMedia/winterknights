  ...
  const submitCompanyForm = async () => {
    ...
    try {
      ...
      if (editingCompany) {
        ...
        await adminApi.createCompanyManual({
          ...payload,
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Create company accounts manually and edit details. Create and update both send one automatic email.
                </p>
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {editingCompany
                  ...
                  : 'Create a company account manually and send welcome credentials.'}
              </DialogDescription>
            </DialogHeader>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                <Label>City *</Label>
                <Select value={companyForm.cityId} onValueChange={(v) => setCompanyForm((f) => ({ ...f, cityId: v }))}>
                  <SelectTrigger>
                    <SelectValue placeholder="Select city" />
                  </SelectTrigger>
                  <SelectContent>
